import {
    PaymentStatus, useGetBlockNumberQuery, useGetNftPriceCapQuery,
...
const MintingContainer = () => {
    ...
    if (getTotalSaleAmountLoading && getBlockNumberLoading && getPriceCapLoading) return <Loading />;
        ...
        <div id="main-wrapper" className="front">
            <div className="container pagetitle-area">
                <div className="col-12">
                    <div className="count-box slot">
                       <MintingCount type={"slot"} totalSaleAmount={totalSaleAmount?.getTotalSaleAmount.totalSaleAmount} />
                    </div>
                </div>
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-12">
                        ...
                        <div className="social">
                            <a href="https://t.me/Khanteum_Channel" ><i className="ri-telegram-fill" style={{fontSize: '32px'}}></i></a>
                            <a href="https://t.me/khanteum_official"><i className="ri-telegram-fill" style={{fontSize: '32px'}}></i></a>
                            <a href="https://www.facebook.com/khanteum.fb" target="_blank"><i className="ri-facebook-circle-fill" style={{fontSize: '32px'}}></i></a>
                            <a href="https://twitter.com/KHAN_ZZANG" target="_blank"><i className="ri-twitter-fill" style={{fontSize: '32px'}}></i></a>
                            <a href={`https://www.youtube.com/${localStorage.getItem('khanway_language') === 'ko' ? 'c/khanteum' : '@KHAN_ZZANG '}`} target="_blank"><i className="ri-youtube-fill" style={{fontSize: '32px'}}></i></a>
                        </div>
                    </div>
                            ...
                            <div className="min-block gridone">
                                ...
                                <div className="count-box">
                                    ...
                                    <MintingCount type={"sale"}
                                                  totalSaleAmount={totalSaleAmount?.getTotalSaleAmount.totalSaleAmount}/>
                                </div>
                            </div>
                            <MintingSubmit priceCap={priceCap?.getNFTPriceCap.nftPriceCap?.sort((a, b) => b.price! - a.price!) ?? []}/>
                        </div>
                    </div>
                </div>
            </div>
