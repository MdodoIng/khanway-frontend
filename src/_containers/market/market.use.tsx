...
const MarketUse = () => {
  ...
  return (
    <div className="container m-use">
      <div className="row">
        <div
          className="col-xl-12 use-title aos-init aos-animate"
          data-aos="fade-up"
        >
          <h1 className="text-line-deco center">{t("market.use_title")}</h1>
        ...
        <div className="col-xl-6 col-lg-6 col-12 use-items" data-aos="fade-up">
          <div className="usebox">
            ...
            <Link to={user ? "/auth/login" : "/auth/login"} className="explore">
        ...
        <div className="col-xl-6 col-lg-6 col-12 use-items" data-aos="fade-up">
          <div className="usebox">
            ...
            <Link
              to={user ? "/profile/wallet" : "/auth/login"}
              className="explore"
            >
              Explore <i className="fa-solid fa-arrow-right-long"></i>
            </Link>
